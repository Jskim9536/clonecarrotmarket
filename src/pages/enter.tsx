  ...
  return (
    <div className="flex min-h-screen flex-col justify-center bg-slate-300">
      <div className="mx-5 rounded-xl bg-white bg-opacity-80 p-5 shadow-md backdrop-blur-sm">
        <h3 className={`mt-${marginBetween} text-center text-3xl font-bold`}>
          Enter to
          <br />
          Carrot
        </h3>
          ...
          <div className="mt-8">
            <div className="relative">
              ...
              <div className="relative -top-3 text-center">
                <span className="bg-white  px-2 text-sm text-gray-500 backdrop-blur-sm">
                  Or enter with
                </span>
              </div>
            </div>
            <div className="mt-2 grid grid-cols-2 gap-3">
              <button className="flex items-center justify-center rounded-md border border-gray-300 bg-gray-300 py-2 px-2 transition-colors duration-300 hover:bg-gray-200">
                <svg
                  className="h-5 w-5"
                  aria-hidden="true"
                  fill="currentColor"
              ...
              <button className="flex items-center justify-center rounded-md border border-gray-300 bg-gray-300 py-2 px-2 hover:bg-gray-200">
                <svg
                  className="h-5 w-5"
                  aria-hidden="true"
                  fill="currentColor"
