    ...
    <div className="px-4 py-10">
      <div>
        ...
        <div className="pt-8">
          ...
          <span className="mt-3 block text-3xl text-gray-500">$140</span>
          ...
          <div className="flex items-center justify-between space-x-2">
            ...
            <button className="flex items-center justify-center rounded-md  p-3 text-gray-400 hover:text-gray-500">
              <svg
                className="h-6 w-6 "
      ...
      <div className="mt-6">
        <h2 className="mb-4 text-2xl font-bold text-gray-800">Similar items</h2>
        <div className="grid grid-cols-2 gap-4">
          {[1, 2, 3, 4, 5, 6].map((_, i) => (
            <div key={i}>
              <div className="mb-2 h-56 w-full rounded-md bg-slate-300" />
              <h3 className="font-bold text-gray-900">Galaxy S60</h3>
